...
export const getOptHomeConditions = async (dim, status, timeField, homeDetailKey) => {
    const depIds = getSessionStorageTempState('homeData', true)?.[homeDetailKey];
    const stageConfig = ref();
    const timeFiledKeyMap = {
