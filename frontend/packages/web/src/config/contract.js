import { ContractBusinessTitleStatusEnum, ContractInvoiceStatusEnum, ContractPaymentPlanEnum, ContractStatusEnum, } from '@lib/shared/enums/contractEnum';
...
export const contractBusinessTitleStatusOptions = Object.entries(contractBusinessTitleStatusMap).map(([key, value]) => ({
    label: value.label,
    value: key,
}));
