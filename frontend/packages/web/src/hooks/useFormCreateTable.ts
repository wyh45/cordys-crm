...
export type FormKey =
  ...
  | FormDesignKeyEnum.HEALTH_ARCHIVE
  | FormDesignKeyEnum.HEALTH_FOLLOW
  | FormDesignKeyEnum.HEALTH_KNOWLEDGE;
...
export default async function useFormCreateTable(props: FormCreateTableProps) {
  ...
  const tableKeyMap = {
    ...
    [FormDesignKeyEnum.HEALTH_ARCHIVE]: undefined,
    [FormDesignKeyEnum.HEALTH_FOLLOW]: undefined,
    [FormDesignKeyEnum.HEALTH_KNOWLEDGE]: undefined,
  };
      ...
      columns = res.fields
        ...
        .map((field): CrmDataTableColumn => {
          ...
          return {
            ...
            sortOrder: false,
            sorter: !noSorterType.includes(field.type) && !field.resourceFieldId ? (sorter as any) : false,
            filedType: field.type,
            resourceFieldId: field.resourceFieldId,
          };
        });
