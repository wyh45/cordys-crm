 ...
 */
export default function useFullScreen(domRef, disabledShortcutKeys = false) {
    ...
    function enterFullScreen() {
        ...
        if (dom) {
            ...
            mergeStyles(dom, 'position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 1000; width: 100%; height: 100%;');
