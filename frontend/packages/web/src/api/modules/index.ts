...
import useHealthApi from '@lib/shared/api/modules/health';
...
const healthApi = useHealthApi(CDR);
...
// 健康类型导出
export type {
  CustomerAbnormalDetail,
  CustomerAbnormalStat,
  ExamItemStat,
  HealthAiEligibleArchive,
  HealthAiInterpretParams,
  HealthAiInterpretRecord,
  HealthAiInterpretResult,
  HealthAllergy,
  HealthArchive,
  HealthArchiveListItem,
  HealthArchiveParams,
  HealthExamAbnormalParams,
  HealthExamAbnormalStat,
  HealthExamination,
  HealthFollow,
  HealthFollowListItem,
  HealthFollowParams,
  HealthFollowRule,
  HealthFollowRuleParams,
  HealthKnowledge,
  HealthKnowledgeListItem,
  HealthKnowledgeParams,
  ...
  HealthVaccination,
  RuleMatchedArchive,
} from '@lib/shared/api/modules/health';
