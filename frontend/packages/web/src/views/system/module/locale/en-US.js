export default {
    ...
    'module.closeModuleTipContent': 'After closing, members will not find the module in the main navigation, please be careful!',
    ...
    'module.customer.disabledTipContent': 'When disabled, accounts will no longer be recycled according to the configured rules',
    ...
    'module.capacitySet.notIncludedTip': 'Accounts who meet the filter criteria will be excluded from capacity calculations.',
