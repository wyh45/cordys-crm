export default {
    ...
    'system.business.notConfiguredTip': 'Please perform a test connection first. This feature can only be enabled after a successful test connection.',
    ...
    'system.business.authenticationSettings.enableConfirmContent': 'Once enabled, this authentication method can be used to log in.',
    'system.business.authenticationSettings.disableConfirmTitle': 'Confirm disabling authentication {name}?',
    'system.business.authenticationSettings.disableConfirmContent': 'Once disabled, this authentication method will no longer be supported for login.',
    ...
    'system.business.authenticationSettings.loginUrlTip': 'If authentication fails, users will be redirected to this login page.',
    ...
    'system.business.authenticationSettings.LDAPPropertyMapTip': 'Left key is Cordys user property, right value is authentication platform user property.',
    ...
    'system.business.authenticationSettings.syncUsersOpenTip': '1. Synchronize {type} QR code login and {type} message notifications',
    'system.business.authenticationSettings.syncUsersTipContent': '2. Sync users from  {type} in organization module',
    'system.business.authenticationSettings.togglePlatformTip': 'Note: Scanning code login and message notifications will invoke the configuration of the switched platform ({type}), which may result in login failure or abnormal message reception. We suggest you operate with caution!',
    'system.business.authenticationSettings.changeCorpIdTip': 'The current enterprise ID does not match the system archive!Docking new enterprises will directly clear the historical enterprise user data, clear careful operation!',
    'system.business.authenticationSettings.innerAppId': 'App ID',
    'system.business.authenticationSettings.innerAppIdPlaceholder': 'Please enter the internal application ID for DingTalk notifications.',
    ...
    'system.config.page.loginPreviewTip': 'Tips: Default is the Cordys system interface, supports custom platform UI settings.',
    'system.config.page.icon': 'Website Logo',
    'system.config.page.iconTip': 'Displayed at the top of the website. Recommended: SVG or PNG format with a transparent background, height under 32px, and file size under 200KB.',
    'system.config.page.loginLogo': 'Login Logo',
    'system.config.page.loginLogoTip': 'Displayed on the right side of the login page. Recommended: SVG or PNG format with a transparent background, height under 48px, and file size under 200KB.',
    'system.config.page.loginBg': 'Login Background',
    'system.config.page.loginBgTip': 'Recommended: SVG format. Vector images: 1440x900px; Bitmap images: 1920x1080px. File size must be under 800KB.',
    ...
    'system.config.page.platformLogoTip': 'Displayed in the theme bar. Recommended: SVG or PNG format with a transparent background, height under 32px, and file size under 200KB.',
    ...
    'system.personal.changePasswordTip': 'Detected that you are currently using the default initial password. For the security of your account, it is recommended to change your password immediately',
