export default {
    ...
    'system.message.confirmCloseSystemNotifyContent': 'After closing, members will no longer receive notifications for this feature',
    ...
    'system.message.weComSwitchTip': '{type} unable to get user receives the message, please complete the WeCom structure synchronization, make sure the system consistent with the {type} personnel data!',
