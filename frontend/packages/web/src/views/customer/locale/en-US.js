export default {
    ...
    'customer.contact.deleteContentTip': 'After deletion, the contact cannot be queried and cannot be recovered. Please proceed with caution!',
    'customer.contact.deleteTitle': 'There is a bound business opportunity, please change the contact person for the business opportunity binding before deleting it!',
    ...
    'customer.claimTipContent': 'After claiming, if there is no follow-up/deal within 180 days, it will be automatically returned to the high seas',
    ...
    'customer.cooperationTip': 'Read Only: Support viewing account basic information and responsible person-related data; Cooperation: Support viewing account basic information and following up accounts',
    ...
    'customer.afterMergeInfoTip': '3. The account after the merger, merged account contact, follow up plan, follow up records, business information, collaboration members later merge to the account',
    'customer.selectedMergeAccountTooltip': "Selected accounts: chosen from list; Other accounts: visible accounts; Owner assignment: only selected accounts' owners can be chosen; other accounts' owners remain unchanged",
