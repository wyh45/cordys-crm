 ...
 */
export function normalizeSerialToSecond(serial) {
    return (Math.floor((serial * DAY_MS) / SECOND_MS) * SECOND_MS) / DAY_MS;
}
function normalizeScalar(value, _) {
 ...
 */
export function toBoolean(value, warn) {
 ...
 */
export function toNumber(value, warn) {
    const v0 = normalizeScalar(value, warn);
    if (v0 == null)
        return 0;
    if (typeof v0 === 'number')
 ...
 */
export function toString(value, warn) {
    const v0 = normalizeScalar(value, warn);
    if (v0 == null)
        return '';
    if (typeof v0 === 'string')
...
function compareEqual(a, b, warn) {
 ...
 * Excel compare
 */
export function excelCompare(left, right, operator, warn) {
    switch (operator) {
        case '=':
...
//# sourceMappingURL=excel-runtime.js.map