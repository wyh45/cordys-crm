 ...
 */
function getTopLevelCommaTokens(tokens) {
    const result = [];
    let depth = 0;
 ...
 */
function findAdjacentTopLevelCommaRange(tokens) {
    let depth = 0;
    let lastTopLevelCommaToken = null;
 ...
 * @returns 诊断错误信息列表
 */
export default function diagnoseArgs(fnNode, args, tokens) {
    const diagnostics = [];
...
//# sourceMappingURL=diagnoseArgs.js.map