export default {
    ...
    'crmFormDesign.pictureLimitDesc': 'The system defaults to a maximum of 10 pictures and a maximum size of 20MB per picture',
    ...
    'crmFormDesign.dataSourceFilterTip': 'After adding filter conditions, only data that meets the conditions will be displayed',
    ...
    'crmFormDesign.formulaFieldChanged': 'Formula field has been modified not exist, please contact the administrator to update the formula!',
    ...
    'crmFormDesign.formulaPlaceholder': 'Select the fields and functions below to configure the calculation formula. For example:',
    ...
    'crmFormDesign.formulaIFSDescription': 'In order to check multiple conditions, and returns the first meet the conditions of the corresponding results',
    ...
    'crmFormDesign.formulaANDDescription': 'Check if multiple conditions are met simultaneously. If all are met, return TRUE; otherwise, return FALSE',
    ...
    'crmFormDesign.tip.CLUE_TO_CUSTOMER': 'When converting a lead to an account, fill the lead form field content into the account form field',
    'crmFormDesign.tip.CLUE_TO_OPPORTUNITY': 'When converting a lead to an opportunity, fill the lead form fields into the opportunity form fields',
    'crmFormDesign.tip.CUSTOMER_TO_OPPORTUNITY': 'When creating an opportunity in the account details, fill the account form fields into the opportunity form fields',
    'crmFormDesign.tip.CLUE_TO_RECORD': 'When writing follow-up records in the lead module, fill the lead form field content into the record form fields',
    'crmFormDesign.tip.CUSTOMER_TO_RECORD': 'When writing follow-up records in the account module, fill the account form field content into the record form fields',
    'crmFormDesign.tip.OPPORTUNITY_TO_RECORD': 'When writing follow-up records in the opportunity module, fill the opportunity form field content into the record form fields',
    'crmFormDesign.tip.PLAN_TO_RECORD': 'When performing plan to record operations, fill the plan form field content into the record form fields',
    'crmFormDesign.tip.CONTRACT_TO_INVOICE': 'When creating an invoice in the contract details, fill the contract form fields into the invoice form fields',
    'crmFormDesign.tip.CLUE_TO_CONTACT': 'When converting a lead to a contact, fill the lead form field content into the contact form fields. Note: The customer name field in the contact form is filled by system logic, please do not configure it!',
    'crmFormDesign.tip.CONTRACT_TO_ORDER': 'When creating an order in the contract details, fill the contract form fields into the order form fields',
