...
import { addAccountPoolView, addBusinessView, addClueView, addContactView, addContractInvoicedView, addContractView, addCustomerView, addFollowPlanView, addFollowRecordView, addLeadPoolView, addOrderView, addPaymentPlanView, addPaymentRecordView, addQuotationView, deleteAccountPoolView, deleteBusinessView, deleteClueView, deleteContactView, deleteContractInvoicedView, deleteContractView, deleteCustomerView, deleteFollowPlanView, deleteFollowRecordView, deleteLeadPoolView, deleteOrderView, deletePaymentPlanView, deletePaymentRecordView, deleteQuotationView, dragAccountPoolView, dragBusinessView, dragClueView, dragContactView, dragContractInvoicedView, dragContractView, dragCustomerView, dragFollowPlanView, dragFollowRecordView, dragLeadPoolView, dragOrderView, dragPaymentPlanView, dragPaymentRecordView, dragQuotationView, enableAccountPoolView, enableBusinessView, enableClueView, enableContactView, enableContractInvoicedView, enableContractView, enableCustomerView, enableFollowPlanView, enableFollowRecordView, enableLeadPoolView, enableOrderView, enablePaymentPlanView, enablePaymentRecordView, enableQuotationView, fixedAccountPoolView, fixedBusinessView, fixedClueView, fixedContactView, fixedContractInvoicedView, fixedContractView, fixedCustomerView, fixedFollowPlanView, fixedFollowRecordView, fixedLeadPoolView, fixedOrderView, fixedPaymentPlanView, fixedPaymentRecordView, fixedQuotationView, getAccountPoolViewDetail, getAccountPoolViewList, getBusinessViewDetail, getBusinessViewList, getClueViewDetail, getClueViewList, getContactViewDetail, getContactViewList, getContractInvoicedViewDetail, getContractInvoicedViewList, getContractViewDetail, getContractViewList, getCustomerViewDetail, getCustomerViewList, getFollowPlanViewDetail, getFollowPlanViewList, getFollowRecordViewDetail, getFollowRecordViewList, getLeadPoolViewDetail, getLeadPoolViewList, getOrderViewDetail, getOrderViewList, getPaymentPlanViewDetail, getPaymentPlanViewList, getPaymentRecordViewDetail, getPaymentRecordViewList, getQuotationViewDetail, getQuotationViewList, updateAccountPoolView, updateBusinessView, updateClueView, updateContactView, updateContractInvoicedView, updateContractView, updateCustomerView, updateFollowPlanView, updateFollowRecordView, updateLeadPoolView, updateOrderView, updatePaymentPlanView, updatePaymentRecordView, updateQuotationView, } from '@/api/modules';
import useUserStore from '@/store/modules/user';
const userStore = useUserStore();
export const viewApiMap = {
    list: {
...
export const internalConditionsMap = {
