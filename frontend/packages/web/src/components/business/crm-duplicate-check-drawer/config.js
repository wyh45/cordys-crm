...
export const lastScopedOptions = computed(() => scopedOptions.filter((e) => appStore.moduleConfigList.find((m) => m.moduleKey === e.moduleKey && m.enable && hasAnyPermission(e.permission))));
export const defaultSearchSetFormModel = {
    searchFields: {}, // 字段map
