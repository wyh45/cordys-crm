export default {
    ...
    'crmImportButton.importAlertDesc': 'Please edit the content according to the format in the Excel template before uploading',
    ...
    'crmImportButton.importNew.tooltip': 'Company name is unique. If multiple duplicate records exist, only the first one will be imported.',
    'crmImportButton.importUpdates': 'Import updates',
    'crmImportButton.importUpdates.tooltip': 'After matching by company name, columns with valid values in the Excel file will overwrite the corresponding records in the system.',
};
