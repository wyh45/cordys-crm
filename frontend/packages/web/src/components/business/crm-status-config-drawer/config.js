...
import { addOpportunityStage, addOrderStatus, deleteOpportunityStage, deleteOrderStatus, getOpportunityStageConfig, getOrderStatusConfig, sortOpportunityStage, sortOrderStatus, updateOpportunityStage, updateOpportunityStageRollback, updateOrderStatus, updateOrderStatusRollback, } from '@/api/modules';
...
function buildDefaultCreateParams(row, list, index, keys) {
    return {
        ...pick(row, keys),
...
function buildDefaultUpdateParams(row, keys) {
    return pick(row, keys);
}
export function useStatusTextConfig() {
    const { t } = useI18n();
    return {
...
export function useStatusFormItemModelConfig() {
    const { t } = useI18n();
    return {
        [FormDesignKeyEnum.BUSINESS]: [
            {
...
export function useStatusApiConfig() {
    return {
        [FormDesignKeyEnum.BUSINESS]: {
...
export function useStatusStrategyConfig() {
