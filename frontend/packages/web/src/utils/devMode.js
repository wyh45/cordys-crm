...
export function isDevMode() {
    ...
    const noBackend = import.meta.env.VITE_DEV_NO_BACKEND;
    if (noBackend === '1' || noBackend === 'true') {
        return true;
    }
    return false;
}
window.__IS_DEV_MODE__ = (import.meta.env.VITE_DEV_NO_BACKEND === '1' || import.meta.env.VITE_DEV_NO_BACKEND === 'true');
/**
 ...
 */
export function mockGetKeyResponse() {
 ...
 */
export function mockIsLoginResponse() {
 ...
 */
export function mockGetThirdConfigResponse() {
 ...
 */
export function mockGetPageConfigResponse() {
    return {};
}
/**
 ...
 */
export function mockLoginResponse(username) {
    return {
 ...
 */
export function initDevModeAuth() {
